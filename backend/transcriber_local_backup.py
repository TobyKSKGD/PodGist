"""
本地语音模型备份 - transcriber.py 的原始本地模型版本

本文件包含 PodGist 原始的本地 Whisper + SenseVoice 语音识别实现。
如需恢复本地模型方案，将本文件重命名为 transcriber.py 即可。

已移除的依赖：openai-whisper, modelscope, funasr, torch
"""
